...
class MainPanel(wx.Panel):
    def __init__(self, parent):
        ...
        # load DB
        loadDBBtn = wx.Button(self, label="データベース選択")
    ...
    def loadTable(self, event):
        ...
        * Load the table into the ObjectListView widget
        ...
        table = Table(current_table, metadata, autoload=True,
    ...
    def setData(self, data=None):
        """
        * Update the ObjectListView widget's contants
        """
        olv_columns = []
...
class MainFrame(wx.Frame):
    def __init__(self):
        super().__init__(parent=None, title="Database Viewer", size=(600, 400))
